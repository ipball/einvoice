...
<div class="modal-body">
    <form id="userForm" action="<?php echo base_url('user/save'); ?>">
        <?php echo form_hidden('id', $result['id']); ?>        
        <div class="row">
            <div class="col-sm-6 col-12 form-group">
                <label>Username <span class="text-danger">*</span></label>                
                <?php echo form_input(array('name' => 'username', 'value' => $result['username'], 'class' => 'form-control', 'autocomplete' => 'off')); ?>
            </div>            
        </div>
        <div class="row">
            <div class="col-sm-6 col-12 form-group">
            ...
            <div class="col-sm-6 col-12 form-group">
                ...
                <?php echo form_password(array('name' => 'password_confirm', 'value' => '', 'class' => 'form-control', 'autocomplete' => 'off')); ?>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-6 col-12 form-group">
